<template>
  <header
    class="bg-white dark:bg-dark-bg-secondary border-b border-light-border-primary dark:border-dark-border-primary shadow-sm h-16 flex items-center justify-between px-6"
  >
    <!-- Left Section -->
    ...
    <div class="flex items-center space-x-4">
      ...
      >
        <button
          class="flex items-center space-x-2 p-2 rounded-lg hover:bg-light-bg-secondary dark:hover:bg-dark-bg-primary transition-colors"
        >
          <div
        ...
        <!-- Profile Dropdown -->
        <div class="dropdown-menu w-52" :class="{ show: isProfileMenuOpen }">
          ...
          <div class="py-1.5">
            <a href="#" class="dropdown-item">
              <div class="flex items-center">
                <svg
                  class="w-4 h-4 mr-2.5 text-light-accent-sport dark:text-dark-accent-sport"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <button @click="toggleTheme" class="dropdown-item w-full text-left">
              <div class="flex items-center">
                <svg
                  v-if="isDark"
                  class="w-4 h-4 mr-2.5 text-light-accent-sport dark:text-dark-accent-sport"
            ...
            >
              <div class="flex items-center">
                <svg
                  class="w-4 h-4 mr-2.5 text-light-accent-danger dark:text-dark-accent-danger"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
